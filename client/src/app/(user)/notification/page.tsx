        ...
        {notifications.length > 0 ? (
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {notification?.event?.artists.map((artist, index) => (
                            <span
                              key={index}
                              className="bg-orange-100 text-orange-700 px-3 py-1.5 rounded-lg text-sm flex items-center gap-1"
                            >
                              <Users size={14} />
                              {artist}
                            </span>
          ...
          <div className="bg-white rounded-xl shadow-lg p-12 text-center flex flex-col items-center">
            ...
            <p className="text-gray-500 text-center max-w-md">
              Your notification center is empty. New notifications will appear
              here when events are booked.
            </p>
          </div>
        )}
      </div>
